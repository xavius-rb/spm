RSpec.shared_examples :resource_controller do |klass, except: []|
    ...
    describe "POST /create" do
      ...
      context "with valid parameters" do
        ...
        it "creates a new #{klass.name}" do
          ...
          expect(flash[:notice]).to match(/#{klass.name} was successfully created.*/)
        end
      end
    ...
    describe "PATCH /update" do
      ...
      context "with valid parameters" do
        ...
        it "updates the requested #{klass.name}" do
          make_request
          expect(flash[:notice]).to match(/#{klass.name} was successfully updated.*/)
        end
      end
